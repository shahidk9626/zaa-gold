        ...
        <div class="card bg-white text-dark border shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="card-title text-dark">Add New Customer</h4>
                        <p class="card-description text-muted">Complete the steps below to onboard a new customer</p>
                    </div>
                ...
                <form id="customerForm" action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                    @csrf

                    <!-- Step 1: Referral & Status -->
                    <div class="step-content" id="step-1">
                        <div class="card bg-light text-dark border p-4 mb-4">
                            <h5 class="card-title text-dark mb-4">Referral & Initial Status</h5>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="referral_code">Referral Code (Optional)</label>
                                    <input type="text" name="referral_code" id="referral_code" class="form-control bg-white text-dark" placeholder="Enter staff or customer referral code (e.g. STFXX1234, CUSXX1234)">
                        ...
                        <div class="card bg-light text-dark border p-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="first_name" required class="form-control bg-white text-dark" placeholder="Enter first name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Last Name</label>
                                    <input type="text" name="last_name" class="form-control bg-white text-dark" placeholder="Enter last name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Father's Name <span class="text-danger">*</span></label>
                                    <input type="text" name="father_name" required class="form-control bg-white text-dark" placeholder="Enter father's name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Mother's Name</label>
                                    <input type="text" name="mother_name" class="form-control bg-white text-dark" placeholder="Enter mother's name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Nominee Name</label>
                                    <input type="text" name="nominee_name" class="form-control bg-white text-dark" placeholder="Enter nominee's name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Date of Birth</label>
                                    <input type="date" name="dob" class="form-control bg-white text-dark">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Gender</label>
                        ...
                        <div class="card bg-light text-dark border p-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="email" name="email" required class="form-control bg-white text-dark" placeholder="Enter email address">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Phone Number <span class="text-danger">*</span></label>
                                    <input type="text" name="phone" required class="form-control bg-white text-dark" placeholder="Enter phone number">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>WhatsApp Number <span class="text-danger">*</span></label>
                                    <input type="text" name="whatsapp_number" required class="form-control bg-white text-dark" placeholder="Enter whatsapp number">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Alternate Number</label>
                                    <input type="text" name="alternate_number" class="form-control bg-white text-dark" placeholder="Enter alternate phone number">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Pincode <span class="text-danger">*</span></label>
                                    <input type="text" name="pincode" required class="form-control bg-white text-dark" placeholder="Enter pincode">
                                </div>
                                <div class="col-12 form-group">
                                    <label>Address <span class="text-danger">*</span></label>
                                    <textarea name="address" required rows="2" class="form-control bg-white text-dark" placeholder="Enter full address"></textarea>
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>City <span class="text-danger">*</span></label>
                                    <input type="text" name="city" required class="form-control bg-white text-dark" placeholder="City">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>State <span class="text-danger">*</span></label>
                                    <input type="text" name="state" required class="form-control bg-white text-dark" placeholder="State">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Country <span class="text-danger">*</span></label>
                                    <input type="text" name="country" required class="form-control bg-white text-dark" placeholder="Country">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                        ...
                        <div class="card bg-light text-dark border p-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="occupation" class="form-control bg-white text-dark" placeholder="e.g. Businessman, Employee">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Annual Income</label>
                                    <input type="text" name="annual_income" class="form-control bg-white text-dark" placeholder="e.g. 5,00,000">
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="bank_name" class="form-control bg-white text-dark" placeholder="Bank Name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Account Number</label>
                                    <input type="text" name="account_number" class="form-control bg-white text-dark" placeholder="Account Number">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>IFSC Code</label>
                                    <input type="text" name="ifsc_code" class="form-control bg-white text-dark" placeholder="IFSC Code">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Branch</label>
                                    <input type="text" name="branch" class="form-control bg-white text-dark" placeholder="Branch Name">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>PAN Number</label>
                                    <input type="text" name="pan_number" class="form-control bg-white text-dark" placeholder="PAN Card Number">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Aadhar Number</label>
                                    <input type="text" name="aadhar_number" class="form-control bg-white text-dark" placeholder="Aadhar Card Number">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div id="documentRows">
                                <div class="row mb-3 doc-row align-items-end">
                                    <div class="col-md-5 form-group">
                                        ...
                                        <input type="text" name="document_names[]" class="validate-doc-name form-control bg-white text-dark" placeholder="e.g. PAN Card, Aadhar Card">
                                    </div>
                                    <div class="col-md-5 form-group">
                    ...
                    <div class="step-content d-none" id="step-6">
                        <div class="card bg-light text-dark border p-4 mb-4">
                            <h5 class="card-title text-dark mb-4">Review Customer details</h5>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" id="submitBtn" class="btn btn-success px-5">
                                <i class="mdi mdi-check mr-1"></i> Confirm & Onboard
                            </button>
                        </div>
                    </div>
                </form>
    ...
    $(document).ready(function () {
        ...
        $('#customerForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    submitBtn.prop('disabled', false).html('<i class="mdi mdi-check mr-1"></i> Confirm & Onboard');
