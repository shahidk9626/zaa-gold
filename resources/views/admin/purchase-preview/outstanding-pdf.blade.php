...
<head>
    <meta charset="utf-8">
    <title>EMAP Outstanding Statement - AurOnGold</title>
    <style>
        @page {
            margin: 45px 35px;
        }
...
<body>
    ...
    <div class="footer">
        ...
        <div class="footer-right">
            AurOnGold Bullion Transactions & EMAP Services
        </div>
    </div>

    <!-- Watermark -->
    <div class="watermark">AURONGOLD</div>
    ...
    <table class="info-table">
        <tr>
            <td>
                <div class="info-label">Selected EMAP Plan</div>
            ...
            <td>
                <div class="info-label">Monthly EMAP</div>
    ...
    <!-- Repayment Schedule -->
    <div class="section-header">EMAP Repayment Schedule</div>
