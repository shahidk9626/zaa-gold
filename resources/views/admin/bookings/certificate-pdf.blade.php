...
<body>
    ...
    <div class="outer-border">
        <div class="inner-border">
            ...
            <div style="position: absolute; top: 0; right: 0; width: 12px; height: 12px; border-top: 2px solid #d4af37; border-right: 2px solid #d4af37;"></div>
            <div style="position: absolute; bottom: 0; left: 0; width: 12px; height: 12px; border-bottom: 2px solid #d4af37; border-left: 2px solid #d4af37;"></div>
            <div style="position: absolute; bottom: 0; right: 0; width: 12px; height: 12px; border-bottom: 2px solid #d4af37; border-right: 2px solid #d4af37;"></div>
                ...
                <tr>
                    <td class="header-logo" valign="top">
                        @if(file_exists(public_path('assets/images/logo.png')))
                            <img src="{{ public_path('assets/images/logo.png') }}" class="logo-img" alt="Logo" style="height: 48px; object-fit: contain;">
                        @else
                            <span style="font-size: 20px; font-weight: bold; color: #b89047;">AurOnGold</span>
                        @endif
                        <div style="font-size: 9px; font-weight: bold; color: #aa8010; letter-spacing: 0.5px; margin-top: 2px;">AurOnGold</div>
                        <div style="font-size: 7px; color: #718096; font-style: italic; margin-top: 1px;">Invest Smart. Grow Secure.</div>
                    </td>
                ...
                <tr>
                        ...
                        <table style="width: 100%; border-collapse: collapse;" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="info-bar-icon-td">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#b89047" stroke-width="2.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                                </td>
                    ...
                    <td class="info-bar-cell">
                        <table style="width: 100%; border-collapse: collapse;" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="info-bar-icon-td">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#b89047" stroke-width="2.5"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                                </td>
                                <td class="info-bar-text-td">
                    ...
                    <td class="info-bar-cell">
                        <table style="width: 100%; border-collapse: collapse;" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="info-bar-icon-td">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#b89047" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                </td>
                                <td class="info-bar-text-td">
                    ...
                    <td class="info-bar-cell">
                        <table style="width: 100%; border-collapse: collapse;" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="info-bar-icon-td">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#b89047" stroke-width="2.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                </td>
                                <td class="info-bar-text-td">
                                            ...
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                                    </td>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
                                                    </td>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                                                    </td>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                                                    </td>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
                                                    </td>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- Green info box -->
                                            <div style="background-color: #f0fff4; border: 1px solid #c6f6d5; padding: 5px; border-radius: 4px; display: block; margin-top: 5px;">
                                                <table style="width: 100%; border-collapse: collapse;" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: middle; font-size: 7.2px; color: #22543d; font-weight: 500; padding-left: 4px; line-height: 1.25;">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                                                    </td>
                                        ...
                                        <div class="card-body" style="padding: 6px 8px;">
                                            <div class="declaration-text" style="font-weight: 600; color: #b7791f; font-size: 7.2px;">
                                                This certificate is NOT a certificate of ownership and does not transfer ownership of the gold.
                                            </div>
                                            <div class="declaration-text" style="padding-left: 4px; font-size: 6.8px; margin-top: 3px;">
                                            ...
                                            <div class="declaration-text" style="font-size: 6.8px; margin-top: 3px;">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                                                    </td>
                                        ...
                                        <div class="card-body">
                                            <div class="declaration-text" style="font-size: 6.8px;">
                                                I confirm that I have read, understood and accepted the AurOnGold Terms & Conditions, Privacy Policy, and Shipping Policy. I understand that this certificate only confirms the price lock and does not guarantee ownership until all contractual obligations are fulfilled.
                                            </div>
                                ...
                                <td class="card-cell-right">
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="padding: 6px 8px;">
                                            ...
                                            <table class="company-declaration-layout" cellspacing="0" cellpadding="0" style="margin-top: 4px;">
                                                <tr>
                                                    <td class="signatory-td">
                                                        <!-- blue ink SVG digital signature representation -->
                                                        <svg width="70" height="18" viewBox="0 0 150 50" style="display: block; margin: auto;">
                                                        ...
                                                        <div style="font-size: 6px; color: #1a202c; font-weight: bold; border-top: 0.5px solid #cbd5e0; margin-top: 2px; padding-top: 1px;">Authorised Signatory</div>
                                                    </td>
                                                    <td class="seal-td">
                                                        <!-- Gold Seal circular SVG representation -->
                                                        <svg width="28" height="28" viewBox="0 0 80 80" style="display: inline-block;">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <table class="card-header-table" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="card-header-icon-td">
                                                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="3"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><rect x="7" y="7" width="3" height="3"/><rect x="14" y="7" width="3" height="3"/><rect x="7" y="14" width="3" height="3"/><rect x="14" y="14" width="3" height="3"/></svg>
                                                    </td>
                                        ...
                                        <div class="card-body" style="padding: 5px 8px;">
                                            <table class="verification-layout" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td class="verification-details-td" width="88%" style="padding-left: 10px;">
                                                        <div style="font-size: 6.5px; font-weight: bold; color: #718096; margin-bottom: 2px;">Scan this QR code to verify:</div>
            ...
            <!-- REGISTERED OFFICE BLOCK -->
            <table class="office-block-table" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 6px; padding: 6px 8px;">
                <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="20%" align="center" valign="middle">
                                    <span style="font-family: 'DejaVu Sans', sans-serif; font-size: 14px; font-weight: bold; color: #b89047; display: block; border: 1.2px solid #b89047; border-radius: 4px; padding: 2px 3px; text-align: center; line-height: 1;">AG</span>
                                </td>
                                <td width="80%" style="padding-left: 6px;" valign="middle">
                                    <div style="font-weight: 700; color: #b89047; font-size: 7.6px; text-transform: uppercase;">AURONGOLD AG</div>
                                    <div style="font-size: 6.2px; color: #718096; line-height: 1.15;">
                    ...
                    <td width="27%" valign="middle" style="border-right: 1px dashed #e2e8f0; padding: 0 6px; text-align: center; font-size: 6.2px; color: #4a5568; line-height: 1.4;">
                        🌐 www.aurongold.in<br>
                        ✉ support@aurongold.in<br>
                        📞 +91 73376 16333
                    </td>
                    <!-- Column 3: Tax Details -->
                    <td width="35%" valign="middle" style="padding-left: 6px; font-size: 6.2px; color: #4a5568; line-height: 1.4;">
