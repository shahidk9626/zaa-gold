    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card bg-white text-dark border shadow-sm">
            <div class="card-body">
                ...
                <form id="offerForm" action="{{ route('offers.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                    @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" name="offer_code" required class="form-control bg-white text-dark" placeholder="e.g. DIWALI50" style="text-transform: uppercase;">
                        </div>

                        <div class="col-md-4 form-group">
                            <label class="text-dark">Offer Name <span class="text-danger">*</span></label>
                            <input type="text" name="offer_name" required class="form-control bg-white text-dark" placeholder="e.g. Diwali Special ₹50 OFF">
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="datetime-local" name="start_date" class="form-control bg-white text-dark">
                        </div>

                        <div class="col-md-4 form-group">
                            <label class="text-dark">End Date</label>
                            <input type="datetime-local" name="end_date" class="form-control bg-white text-dark">
                        </div>

                        <div class="col-md-4 form-group">
                            <label class="text-dark">Priority Order</label>
                            <input type="number" name="priority" value="0" min="0" class="form-control bg-white text-dark" placeholder="Higher priority is checked first">
                        </div>

                        <div class="col-md-6 form-group">
                            <label class="text-dark">Upload Offer Banner Image (Optional)</label>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="plans[]" class="form-control select2-plans" multiple="multiple" required style="width: 100%;">
                                @foreach($plans as $plan)
                                    <option value="{{ $plan->id }}">{{ $plan->plan_name }} ({{ $plan->plan_code }})</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 form-group">
                            ...
                            <textarea name="offer_description" rows="3" class="form-control bg-white text-dark" placeholder="Describe the terms and benefits..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-8 form-group type-container" id="percentage_container" style="display: none;">
                            <label class="text-dark">Discount Percentage (%) <span class="text-danger">*</span></label>
                            <input type="number" name="percentage" id="percentage" min="0.01" max="100.00" step="0.01" class="form-control bg-white text-dark" placeholder="e.g. 10.00">
                            <small class="text-muted">Calculates discount based on Total Plan Value after GST and charges.</small>
                        </div>

                        <!-- FIXED CONTAINER -->
                        <div class="col-md-8 form-group type-container" id="fixed_container" style="display: none;">
                            <label class="text-dark">Discount Amount (₹) <span class="text-danger">*</span></label>
                            <input type="number" name="fixed_amount" id="fixed_amount" min="0.01" step="0.01" class="form-control bg-white text-dark" placeholder="e.g. 1000.00">
                    ...
                    <div class="d-flex justify-content-end mt-4 pt-3 border-top">
                        <button type="submit" id="submitBtn" class="btn btn-primary px-4">
                            <i class="mdi mdi-check mr-1"></i> Save Offer
                        </button>
                    </div>
                </form>
            </div>
    ...
    $(document).ready(function () {
        ...
        $('#offerForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    submitBtn.prop('disabled', false).html('<i class="mdi mdi-check mr-1"></i> Save Offer');
