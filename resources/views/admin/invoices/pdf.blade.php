...
<body>
    <div class="container">
        ...
        <table class="info-table">
            <tr>
                ...
                <td>
                    ...
                    <strong>Plan:</strong> {{ $plan->plan_name }} ({{ $booking->duration_months }} Months)<br>
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <small style="color: #666;">Payment ID: {{ $payment->payment_number }} (Receipt: {{ $payment->receipt_number }})</small>
                    </td>
        ...
        <div style="font-weight: bold; margin-bottom: 20px; font-size: 11px;">
            Amount in Words: <span style="text-transform: capitalize; color: #3f50f6;">{{ $amountInWords }}</span>
        </div>
        ...
        <div class="terms-box">
            ...
            2. Gold weight allocation is subject to price lock guarantees specified in the certificate #{{ $booking->certificate->certificate_number ?? 'N/A' }}.<br>
            ...
            <tr>
                ...
                <td width="50%" style="vertical-align: bottom;">
                    <div class="signature-box">
                        ...
                        <small style="font-weight: normal; color: #888;">Generated By: {{ $generatedBy }}</small>
                    </div>
                </td>
            </tr>
        </table>
