                ...
                <form id="planForm" action="{{ route('emi-plans.update', $plan->id) }}" method="POST" class="mt-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" name="cancellation_charge_percent" required min="0" max="100" step="0.01" value="{{ $plan->cancellation_charge_percent }}" class="form-control bg-white text-dark">
                        </div>
                        ...
                        <div class="col-md-12 form-group mb-4">
                            ...
                            <select name="offers[]" class="form-control select2-offers" multiple="multiple" style="width: 100%;">
                                @foreach($offers as $offer)
                                    <option value="{{ $offer->id }}" {{ $plan->offers->contains($offer->id) ? 'selected' : '' }}>{{ $offer->offer_name }} ({{ $offer->offer_code }}) - {{ $offer->offer_type }}</option>
                                @endforeach
                            </select>
