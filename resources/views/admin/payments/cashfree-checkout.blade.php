...
@section('content')
<div class="row justify-content-center text-dark mt-4">
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm" style="border-radius: 12px; background-color: #ffffff;">
            <div class="card-body p-5 text-center bg-white rounded">
                ...
                @if(!$paymentSessionId)
                    ...
                    <a href="{{ route('bookings.index') }}" class="btn btn-outline-primary">Go to Bookings</a>
                @else
