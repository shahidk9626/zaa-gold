        ...
        <div class="card bg-white text-dark border shadow-sm">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="card-title text-dark">Add New Staff</h4>
                        <p class="card-description text-muted">Complete the steps below to register a new employee</p>
                    </div>
                ...
                <form id="staffForm" action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                    @csrf
                        ...
                        <div class="card bg-light text-dark border p-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    @if(count($roles) == 0)
                                        <p class="text-danger small font-weight-bold mt-1">No active roles found!</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-light text-dark border p-4 mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="alternate_phone" class="form-control bg-white text-dark" placeholder="Enter alternate phone number">
                                </div>
                                <div class="col-md-6 form-group">
                        ...
                        <div class="card bg-light text-dark border p-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="department" class="form-control bg-white text-dark" placeholder="e.g. Sales">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Designation</label>
                                    <input type="text" name="designation" class="form-control bg-white text-dark" placeholder="e.g. Manager">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Joining Date <span class="text-danger">*</span></label>
                                    <input type="date" name="joining_date" required class="form-control bg-white text-dark">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Salary</label>
                                    <input type="number" step="0.01" name="salary" class="form-control bg-white text-dark" placeholder="Salary amount">
                                </div>
                    ...
                    <div class="step-content d-none" id="step-5">
                        <div class="card bg-light text-dark border p-4 mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h5 class="card-title text-dark mb-0">Additional Documents</h5>
                            ...
                            <div id="documentRows">
                                <div class="row mb-3 doc-row align-items-end">
                                    <div class="col-md-5 form-group">
                                        ...
                                        <input type="text" name="document_names[]" class="validate-doc-name form-control bg-white text-dark" placeholder="e.g. Aadhar Card">
                                    </div>
                                    <div class="col-md-5 form-group">
                    ...
                    <div class="step-content d-none" id="step-6">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" id="submitBtn" class="btn btn-success px-5">
                                <i class="mdi mdi-check mr-1"></i> Submit Form
                            </button>
                        </div>
                    </div>
                </form>
...
<script>
    $(document).ready(function () {
        ...
        function validateCurrentStep() {
            ...
            // Validate standard fields in current step
        ...
        $('#staffForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    submitBtn.prop('disabled', false).html('<i class="mdi mdi-check mr-1"></i> Submit Form');
