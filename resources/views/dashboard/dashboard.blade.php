          ...
          <div class="card-body px-3 py-4">
            <div class="d-flex justify-content-between align-items-start">
              <div class="color-card">
                ...
                <h2 class="text-white"> ₹{{ number_format($salesVal, 2) }}
                </h2>
              </div>
              <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-warning"></i>
            </div>
            <h6 class="text-white">Active Monthly Collection</h6>
          </div>
        </div>
      </div>
      <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
          ...
          <div class="card-body px-3 py-4">
            <div class="d-flex justify-content-between align-items-start">
              <div class="color-card">
                ...
                <h2 class="text-white"> ₹{{ number_format($marginVal, 2) }}
                </h2>
              </div>
              <i class="card-icon-indicator mdi mdi-cube-outline bg-inverse-icon-danger"></i>
            </div>
            <h6 class="text-white">Total Outstanding Amount</h6>
          </div>
        </div>
      </div>
          ...
          <div class="card-body px-3 py-4">
            <div class="d-flex justify-content-between align-items-start">
              <div class="color-card">
                ...
                <h2 class="text-white"> {{ number_format($ordersVal) }}
                </h2>
              </div>
              <i class="card-icon-indicator mdi mdi-briefcase-outline bg-inverse-icon-primary"></i>
            </div>
            <h6 class="text-white">Active Plan Bookings</h6>
          </div>
        </div>
      </div>
          ...
          <div class="card-body px-3 py-4">
            <div class="d-flex justify-content-between align-items-start">
              <div class="color-card">
                ...
                <h2 class="text-white">{{ number_format($affiliateVal) }}</h2>
              </div>
              <i class="card-icon-indicator mdi mdi-account-circle bg-inverse-icon-success"></i>
            </div>
            <h6 class="text-white">Registered Referrals</h6>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
            ...
            <div class="card mb-3 mb-sm-0">
              <div class="card-body py-3 px-4">
                ...
                <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                  <div>
                    <h3 class="m-0 survey-value">₹{{ number_format($todayEarnings) }}</h3>
                    <p class="text-success m-0">Today's cashflow</p>
                  </div>
          ...
          <div class="col-sm-4">
            <div class="card mb-3 mb-sm-0">
              <div class="card-body py-3 px-4">
                ...
                <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                  <div>
                    <h3 class="m-0 survey-value">{{ number_format($productSold, 2) }} g</h3>
                    <p class="text-danger m-0">Accumulated gold weight</p>
                  </div>
          ...
          <div class="col-sm-4">
            <div class="card">
              <div class="card-body py-3 px-4">
                ...
                <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                  <div>
                    <h3 class="m-0 survey-value">{{ number_format($todayOrders) }}</h3>
                    <p class="text-success m-0">New bookings logged</p>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <h5 class="d-inline-block survey-value mb-0"> ₹{{ number_format($totalCollected) }} </h5>
            <p class="d-inline-block text-danger mb-0"> total collection </p>
          </div>
        </div>
      </div>
    </div>
