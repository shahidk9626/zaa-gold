<x-guest-layout>
    <div class="mb-4 text-center">
        <h4 class="font-weight-bold text-white mb-2">Verify Your Email Address</h4>
        <p class="text-muted">An OTP has been sent to <strong>{{ $email }}</strong></p>
    </div>
    ...
    <form method="POST" action="{{ route('customer.verify-email') }}">
        @csrf
    ...
    <form method="POST" action="{{ route('customer.resend-email-otp') }}" class="text-center">
        @csrf
