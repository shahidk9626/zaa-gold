<x-customer-layout title="Repay EMAP">
    <div class="page-header flex-wrap d-none d-md-flex"><h3 class="mb-0">Repay EMAP</h3></div>
    <div class="d-block d-md-none mb-3"><h5 class="font-weight-bold">Upcoming EMAP</h5></div>

    @if($upcomingEmis->isEmpty())
        <div class="alert alert-success"><i class="mdi mdi-check-circle"></i> All EMAPs are up to date. No pending payments.</div>
    @else
        <div class="card">
            <div class="card-body">
                @php
