...
class UpdateEmiPlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'plan_name' => 'required|string|max:255|unique:emi_plans,plan_name,' . $id,
            'plan_code' => 'required|string|max:255|unique:emi_plans,plan_code,' . $id,
