...
class FranchiseService
{
     ...
     */
    public function assignEnquiry(FranchiseEnquiry $enquiry, $staffId)
    {
        ...
        $this->logDirectActivity(
            ...
            $enquiry->id,
            'assigned',
            "Franchise enquiry assigned to {$newAssignedName} (previously: {$oldAssignedName})"
        );
    }
     ...
     */
    public function updateStatus(FranchiseEnquiry $enquiry, $status, $remarks = null)
    {
     ...
     */
    public function addInternalNote(FranchiseEnquiry $enquiry, $note)
    {
        $this->logDirectActivity(
            'franchise_enquiry',
            $enquiry->id,
     ...
     */
    public function getTimeline(FranchiseEnquiry $enquiry)
    {
        return ActivityLog::where('module_name', 'franchise_enquiry')
